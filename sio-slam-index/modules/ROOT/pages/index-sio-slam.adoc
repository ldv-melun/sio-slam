...
La pierre angulaire du contenu pourrait s'appuyer sur les logiques du 3 tiers web et des couches




**Client HTTP + UI** : HTML/CSS/DOM/JS et HTTP

**LOGIQUE APPLICATIVE et METIER** : facteurs de qualité du code, programmation objet, un peu de fonctionnel, structuration en couche, framework, analyse et ORM, patterns… et HTTP

**LOGIQUE DE PERSISTANCE** : SQL et NoSQL (après le stage?)
