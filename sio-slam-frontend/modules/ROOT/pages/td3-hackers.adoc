...
Faire de même pour le `footer` et `home` (pour ce dernier composant, on présente un peu plus loin comment organiser son template, pour l'instant accepter le contenu par défaut)
