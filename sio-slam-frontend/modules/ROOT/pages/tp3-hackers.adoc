  ...
  <form [formGroup]="hackerForm" (ngSubmit)="onSubmit()"> <1> <2>
    ...
    <div class="form-group pt-2">
        <div class="form-group float-end">
            <button type="button" class="btn btn-success m-2" (click)="clear()">Cancel</button> <3>
...
<3> (click)="clear()", même logique que (2), sur le clic d'un bouton.
...
. Le bouton _Cancel_ n'engage aucune action. Faire en sorte qu'il réinitialise le formulaire.
